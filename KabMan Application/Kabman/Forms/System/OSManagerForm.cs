...
{
    public partial class OSManagerForm : DevExpress.XtraEditors.XtraForm
    {
        public OSManagerForm()
        {
            Icon = Resources.GetIcon("KabManIcon");

            InitializeComponent();

            CManager.SelectProcedure = sproc.OS_Select_All;
            CManager.UpdateProcedure = sproc.OS_Update_ByID;
            CManager.InsertProcedure = sproc.OS_Insert;
            CManager.DeleteProcedure = sproc.OS_Delete_ByID;
        ...
        private void OSManagerForm_Load(object sender, EventArgs e)
        {
