...
namespace KabMan.Import
{
    ...
    public class Dasd : IAcronymComponent
    {
        ...
        public void Parse(string argAcronym)
        {
            ...
            {
                XtraMessageBox.Show(String.Format("Dasd acronym {0} could not be parsed!", argAcronym), "KabMan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        {
            return RegexAssistant.RegexMatched(regex.DasdAcronym, argAcronym);
        }
        #endregion
    }
}
